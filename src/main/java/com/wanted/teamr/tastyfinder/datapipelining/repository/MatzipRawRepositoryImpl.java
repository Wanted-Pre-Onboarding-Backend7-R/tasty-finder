    ...
    public void insertBatch(List<MatzipRaw> matzipRaws) {
        ...
        final String sql =
                "insert into matzip_raw (biz_nm_lotno_addr, sigun_nm, sigun_cd, bizplc_nm, licensg_de, " +
                    ...
                    "bsnsite_circumfr_div_nm, sanittn_indutype_nm, sanittn_bizcond_nm, tot_emply_cnt, " +
                ...
                "values (:bizNameLotNoAddr, :sigunNm, :sigunCd, :bizplcNm, :licensgDe, " +
                    ...
                    ":bsnsiteCircumfrDivNm, :sanittnIndutypeNm, :sanittnBizcondNm, :totEmplyCnt, " +
                    ":refineLotnoAddr, :refineRoadnmAddr, :refineZipCd, :refineWgs84Logt, :refineWgs84Lat, " +
                    "CURRENT_TIMESTAMP, CURRENT_TIMESTAMP) as new " +
